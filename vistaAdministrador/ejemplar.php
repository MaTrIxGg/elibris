    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema biblioteca <small>Administración libro</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">             
                <li role="presentation"><a href="<?= REGISTRAR_LIBRO['url'] ?>">Libro</a></li>               
                    <li role="presentation" class="active"><a href="<?= REGISTRAR_EJEMPLAR['url'] ?>">Ejemplar</a></li>  
            </ul>
        </div>
         ...
         <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Nuevo ejemplar</li>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Agregar un nuevo ejemplar</div>
                <form method="POST" action="<?= GUARDAR_EJEMPLAR['url'] ?>" autocomplete="off"> 
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" name="eje_codigounico"class="material-control tooltips-general" placeholder="Ingrese el código único del ejemplar" required="" pattern="[0-9]{1,10}" maxlength="10" >
                           ...
                           <div class="col-xs-offset-2 col-md-8 col-sm-offset-3">
                            ...
                            <div class="group-material">                              
                                <span>Título Libro</span>
                                    <select name="eje_idlibro"class="tooltips-general material-control">
                                        <option value="0">Selecciona el libro</option>                                    
                                        <?php foreach ($listaLibroEjemplar as $resultadoLibroEje) { ?>                                              
                        ...
                        ?>
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="date" name="eje_fechaingreso"class="material-control tooltips-general" value="<?php echo $fecha;?>" required="" pattern="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                <span>Estado</span>                               
                                <select name="eje_idestado"class="tooltips-general material-control" disabled="">                                                  
                                        <?php foreach ($listaEstadoEjemplar as $resultadoEstadoEje ) { ?>                                              
                                            <option value="<?= $resultadoEstadoEje ->idestado ?>"><?= $resultadoEstadoEje->nombreestado ?></option>                                                                                                  
                                        <?php }
                                        ?>
                                    </select>           
                            </div>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <div class="group-material">
                               <input type="text" name="eje_descripcion"class="material-control tooltips-general" placeholder="Descripción del libro" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50">
                                <span class="highlight"></span>
                                <span class="bar"></span>
