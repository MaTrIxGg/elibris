            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            <li><a href="<?= REGISTRAR_AUTOR['url'] ?>">Nuevo autor</a></li>
                            <li class="active">Listado autores</li>
                        </ol>
                    </div>
                </div>                   
            </div>
                ...
                <thead>
                    <tr>
                            ...
                            <tbody>
                                ...
                                <tr>                                                                        
                                    <td class="div-table-cell"><?= $resultado->nombresautor ?></td>
                                    <td class="div-table-cell"><?= $resultado->apellidosautor ?></td>
                                    <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_AUTOR['url'].'?idautor='.$resultado->idautor?>" class="btn btn-success"> 
