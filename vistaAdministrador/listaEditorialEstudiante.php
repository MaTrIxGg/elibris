     ...
     <div class="navbar-lateral full-reset">
        ...
        <div class="container">
            <div class="page-header">
             <h1 class="all-tittles">Sistema biblioteca <small>editorial</small></h1>
            </div>
        </div>        
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                <?php foreach ($listaEstudiante as $resultadoEstudiante) { ?>    
                                <tr>                                                                       
                                    <td class="div-table-cell"><?= $resultadoEstudiante->nombreeditorial ?></td>                                                                                                   
                                </tr> 
                                <?php }
                 ?>              
                            </tbody>
