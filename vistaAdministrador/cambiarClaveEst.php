...
<!--        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="<?= PROYECTO_RECURSOS_ASSETS_IMG ?>configuracion.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para modificar la clave de la cuenta, se deben de llenar todos los campos del siguiente formulario para poder modificar la clave exitosamente.
                </div>
            </div>
</div>      --><br>
