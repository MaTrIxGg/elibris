...
<!--                        <li><a href="<?= CATALOGO_ESTUDIANTE['url'] ?>"><i class="zmdi zmdi-bookmark-outline zmdi-hc-fw"></i>&nbsp;&nbsp;Catalogo</a></li> -->
                        <li>
                                ...
                                <li><a href="<?= CONSULTAR_LIBRO_ESTUDIANTE['url'] ?>"><i class="zmdi zmdi-book zmdi-hc-fw"></i>&nbsp;&nbsp;Libros</a></li>                           
                        <li>
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema biblioteca <small>Listado reserva</small></h1>
            </div>
        </div>        
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?= REGISTRAR_RESERVA ['url'] ?>">Nueva reserva</a></li>
                      <li class="active">Listado de Reserva</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de Reservas</h2>
            <div class="div-table">
    ...
    <div class="container-fluid">        
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    <tr>                        
                    <th class="div-table-cell">Documento Usuario</th>
                    <th class="div-table-cell">Cód. Único</th>                  
                    <th class="div-table-cell">Fecha solicitada</th>                   
                    <th class="div-table-cell">Fecha fin</th>                                     
                    <th class="div-table-cell">Estado</th>                                             
                    <th class="div-table-cell">Actualizar</th>     
                    <th class="div-table-cell">Cancelar</th>  
<!--                    <th class="div-table-cell">Préstamo</th> -->
                                </tr>
                            </thead>
                          
                            <tbody>
                              <?php                               
                          foreach ($listaReservasEst as $resultadoReservaEst) { ?> 
                                <tr>
                            <td class="div-table-cell"><?= $resultadoReservaEst->numerodocumento ?></td>
                            <td class="div-table-cell"><?= $resultadoReservaEst->codigounico ?></td>                            
                            <td class="div-table-cell"><?= $resultadoReservaEst->fechainicio ?></td>                           
                            <td class="div-table-cell"><?= $resultadoReservaEst->fechafin ?></td>                             
                            <td class="div-table-cell"><?= $resultadoReservaEst->nombreestado ?></td>                  
                            <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_RESERVA['url'].'?idreserva='.$resultadoReservaEst->idreserva?>" class="btn btn-success"> 
                                                      <i class="zmdi zmdi-refresh"></i>
                                          </a></td> 
                                          <td class="div-table-cell"><a href="<?=CANCELAR_RESERVA['url'].'?idreserva='.$resultadoReservaEst->idreserva?>" class="btn btn-info"> 
                                                      <i class="zmdi zmdi-timer-off"></i>
                                          </a></td> 
<!--                                          <td class="div-table-cell"><a href="<?=REGISTAR_PRESTAMO_RESERVA['url'].'?idreserva='.$resultadoReserva->idreserva?>" class="btn btn-warning"> 
