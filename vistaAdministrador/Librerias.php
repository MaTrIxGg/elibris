        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema bibliotecario <small>listas</small></h1>
                </div>
            </div>
                            ...
                            <div class="row">                               
                               <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-account zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_AUTOR ['url'] ?>"> <h3 class="text-center">Consulta Autores</h3></a></p>
                                    </div>
                                </div> 
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-collection-text zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_EDITORIAL ['url'] ?>"> <h3 class="text-center">Consultar Editoriales</h3></a></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-book zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_LIBRO ['url'] ?>"> <h3 class="text-center">Consultar Libros</h3></a></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-assignment zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_EJEMPLAR ['url'] ?>"> <h3 class="text-center">Consultar Ejemplares</h3></a></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-calendar zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_RESERVA['url'] ?>"> <h3 class="text-center">Consultar Reservas</h3></a></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-timer zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_PRESTAMO['url'] ?>"> <h3 class="text-center">Consultar Préstamos</h3></a></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="full-reset report-content">
                                        <p class="text-center">
                                            <i class="zmdi zmdi-time-restore zmdi-hc-3x" >   
                                            </i>                                                          
                                        <a href="<?= CONSULTAR_DEVOLUCION['url'] ?>"> <h3 class="text-center">Consultar Devoluciones Pendiantes</h3></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
