    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation" class="active"><a href="<?= CONSULTAR_RESERVA['url'] ?>">Reservas</a></li>
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Préstamo</th> 
                            ...
                            <tbody>
                              <?php                               
                          foreach ($listaReservas as $resultadoReserva) { ?> 
                                <tr>
                            <td class="div-table-cell"><?= $resultadoReserva->numerodocumento ?></td>
                            <td class="div-table-cell"><?= $resultadoReserva->codigounico ?></td>                            
                            <td class="div-table-cell"><?= $resultadoReserva->fechainicio ?></td>                           
                            <td class="div-table-cell"><?= $resultadoReserva->fechafin ?></td>                             
                            <td class="div-table-cell"><?= $resultadoReserva->nombreestado ?></td>                  
