            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Ver Disponibilidad</th>  
                            ...
                            <tbody>
                              <?php 
                          foreach ($listaLibroDocente as $resultadoLibroDocente) { ?> 
                               <tr>                                                                                                                    <td class="div-table-cell"><img  src="<?= PROYECTO_RECURSOS_AR.$resultadoLibroDocente->ruta?>" width="80px" height="80px"></td>                   
                            <td class="div-table-cell"><?= $resultadoLibroDocente->nombredewey ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroDocente->codigoisbn ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroDocente->titulolibro ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroDocente->nombresautor ?></td> 
                            <td class="div-table-cell"><?= $resultadoLibroDocente->nombreeditorial ?></td>
                             <td class="div-table-cell"><?= $resultadoLibroDocente->ubicacion ?></td>      
                         <td class="div-table-cell"><a href="<?=CONSULTAR_EJEMPLAR_DOCENTE['url'].'?idlibro='.$resultadoLibroDocente->idlibro?>" class="btn btn-info"> 
