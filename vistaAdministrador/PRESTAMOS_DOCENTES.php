...
WHERE U.rol= 3";
	...
	$pdf->AddPage();	
     ...
     $pdf->MultiCell(0, 5, utf8_decode('En este documento se puede evidenciar  todos los préstamos que fueron solicitados por los Docentes Lleristas, teniendo en cuenta los siguientes datos (número de documento del docente, el código del ejemplar que se préstamo, la fecha en que se hizo el préstamo y su estado actual.'), 0,'L',0);     
     $pdf->Ln();
     $pdf->SetFont('Arial','B',14);  
     $pdf->MultiCell(0, 5,utf8_decode('PRÉSTAMOS POR DOCENTES'), 0,'C',0);
     $pdf->Ln();        
