...
<html lang="es">
    <head>
        ...
        <!--<link href="paginacion/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />-->
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" type="text/css">
<!-- JQuery DataTable Css -->
<link href="<?= PROYECTO_RECURSOS_ASSETS_PLUGINSP ?>dataTables.bootstrap4.min.css" rel="stylesheet">
<!-- Custom Css -->
<link href="<?= PROYECTO_RECURSOS_CSSP ?>main2.css" rel="stylesheet">
        ...
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>Proceso de préstamo</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                  <li role="presentation" ><a href="<?= CONSULTAR_RESERVA['url'] ?>">Reservas</a></li>
                  <li role="presentation"class="active"><a href="<?= CONSULTAR_PRESTAMO ['url'] ?>">Préstamo</a></li>  
                  <li role="presentation"><a href="<?= CONSULTAR_DEVOLUCION['url'] ?>">Devoluciones</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            <li><a href="<?= REGISTRAR_PRESTAMO ['url'] ?>">Nuevo Préstamo</a></li>
                            <li class="active">Listado de Préstamo</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<!--                                                        <th class="div-table-cell">Actualizar</th>     -->
                                                        <!--<th class="div-table-cell">Devolución</th>-->  
                                                    </tr>
                                                </thead>                        
                             <tbody>
                                                    <?php foreach ($listaprestamo as $resultadoPrestamo) { ?> 
                                                      <tr>                                                                                                                              
                                                          <td class="div-table-cell"><?= $resultadoPrestamo->numerodocumento ?></td>                                    <td class="div-table-cell"><?= $resultadoPrestamo->codigounico ?></td>                                       <td class="div-table-cell"><?= $resultadoPrestamo->fechaprestamo ?></td>                                     <td class="div-table-cell"><?= $resultadoPrestamo->fechalimite ?></td>                                      
<!--                                                          <td class="div-table-cell"><a href="<?= MOSTRAR_MODIFICAR_PRESTAMO['url'] . '?idprestamo=' . $resultadoPrestamo->idprestamo ?>" class="btn btn-success"> 
                                                                  <i class="zmdi zmdi-refresh"></i>
                                                              </a></td> -->
<!--                                                              <td class="div-table-cell"><a href="<?= MOSTRAR_DEVOLUCION['url'] . '?idprestamo=' . $resultadoPrestamo->idprestamo ?>" class="btn btn-info"> 
