        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container-fluid">
                ...
                <div class="div-table">
                  ...
                  <tbody>
                      <?php foreach ($listaEjemplarEs as $resultadoEjemplarEs) { ?>    
                        <tr>                                                                          
                            <td class="div-table-cell"><?= $resultadoEjemplarEs->codigounico ?></td>            
                            <td class="div-table-cell"><?= $resultadoEjemplarEs->titulolibro ?></td>                                                        
                            <td class="div-table-cell"><?= $resultadoEjemplarEs->descripcion ?></td>                                                                        
                            <td class="div-table-cell"><a href="<?= REGISTAR_RESERVA_EJEMPLAR['url'] . '?idejemplar=' . $resultadoEjemplarEs->idejemplar ?>" class="btn btn-warning"> 
