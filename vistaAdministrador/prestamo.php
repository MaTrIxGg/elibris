    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            ...
            <div class="container-fluid">           
                ...
                <form method="POST" action="<?= GUARDAR_PRESTAMO['url'] ?>" autocomplete="off"> 
                    <div class="row">                      
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                            <div class="group-material">                              
                                ...
                                <select name="pre_idejemplar"class="tooltips-general material-control">
                                    <option value="0">Selecciona el ejemplar</option>                                    
                                    <?php foreach ($listaEjemplarpre as $resultadoEjemplarpre) { ?> 
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2"> 
                            <div class="group-material">                              
                                <span>Usuario</span>
                                <select name="pre_idusuario"class="tooltips-general material-control">
                                    <option value="0">Seleccionar el usuario</option>                                    
                                    <?php foreach ($listaUsuariopre as $resultadoUsuariopre) { ?>                                              
...
$nuevafecha = date ( 'Y-m-j' , $nuevafecha );
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                            <div class="group-material">                              
                                <span>Estado</span>
                                <select name="pre_idestado"class="tooltips-general material-control" disabled="">                       
                                    <?php foreach ($listaEstadopre as $resultadoEstadopre) { ?>                                              
