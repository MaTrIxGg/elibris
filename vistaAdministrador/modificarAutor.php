...
<br>
         <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?= REGISTRAR_AUTOR['url']?>">Nuevo Autor / </li>
                      <li><a href="<?= CONSULTAR_AUTOR['url']?>">Listado de autores</a></li>
                      <li class="active">Modificar de datos Autor</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="<?= MODIFICAR_AUTOR['url'].'?idautor='.$autor->getIdautor()?>">
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" name="aut_nombresautor" value="<?= $autor->getNombresautor() ?>" class="material-control tooltips-general" placeholder="Nombres del autor" required="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]+{2,48}" maxlength="50">
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                             <div class="group-material">
                                <input type="text" name="aut_apellidosautor" value="<?= $autor->getApellidosautor() ?>"class="material-control tooltips-general" placeholder="Apellidos del autor" required pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]+{2,48}">
                                <span class="highlight"></span>
                                <span class="bar"></span>
