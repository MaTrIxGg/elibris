...
<br>
         <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?= REGISTRAR_EDITORIAL['url']?>">Nueva Editorial / </li>
                      <li><a href="<?= CONSULTAR_EDITORIAL['url']?>">Listado de editoriales</a></li>
                      <li class="active">Modificar de datos Editorial</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Modificación de datos del autor </div>
                <form autocomplete="off" method="POST" action="<?= MODIFICAR_EDITORIAL['url'].'?ideditorial='.$editorial->getIdeditorial()?>">
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" name="edi_nombreeditorial" value="<?= $editorial->getNombreeditorial() ?>" class="material-control tooltips-general" placeholder="Nombre de la editorial" required="" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}">                                                              
