        ...
        <nav class="navbar-user-top full-reset">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>Añadir libro</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">              
                    <li role="presentation" class="active"><a href="<?= REGISTRAR_LIBRO['url'] ?>">Libro</a></li>               
                    <li role="presentation"><a href="<?= REGISTRAR_EJEMPLAR['url'] ?>">Ejemplar</a></li>                    
                </ul>
            </div>
<br>
            <div class="container-fluid">
            ...
            <div class="container-fluid">           
                <div class="container-flat-form">
                    ...
                    <form method="POST" action="<?= GUARDAR_LIBRO['url'] ?>" enctype="multipart/form-data" > 
                        <div class="row"> 
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">                                    
                                    <span>Categoría</span>                                     
                                    <select name="lib_iddewey" class="tooltips-general material-control">
                                        <option value="0">Seleccionar categoria</option>                                                                                                                                         
                                        <?php foreach ($listaCategoria2 as $resultadoCategoria2) {
                                            ?>                                              
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input type="number" name="lib_codigoisbn" class="tooltips-general material-control" placeholder="Código ISBN del libro" pattern="[0-9]{1,20}" required="" maxlength="20">
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input type="text" name="lib_titulolibro"class="tooltips-general material-control" placeholder="Escribe aquí el título o nombre del libro" pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]{2,48}" required >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Título</label>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <span>Autor</span>
                                    <select name="lib_idautor" class="tooltips-general material-control">
                                    <option value="0">Seleccionar Autor</option>                                                                                                                                                             
                                        <?php foreach ($listaAutor2 as $resultadoAutor2) {
                                            ?>                                              
                                            <option value="<?= $resultadoAutor2->idautor ?>"><?= $resultadoAutor2->nombresautor ?> <?= $resultadoAutor2->apellidosautor ?></option>                                                                                                  
                                        <?php }
                                        ?>
                                </select>                                                                                                                                 </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">              
                                <div class="group-material">
<!--<input type="file" name="fot_nombre[]" id="nuevofile"/>-->
                                    <input type="file" name="fot_nombre[]"class="tooltips-general material-control" placeholder=""  maxlength="50">                                    
                                    <span class="highlight"></span>
                                    <span class="bar"></span>                                 
                                    <label>Foto</label>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <span>Editorial</span>
                                    <select name="lib_ideditorial"class="tooltips-general material-control" maxlength="50">
                                        <option value="0">Selecciona una editorial</option>                                    
                                        <?php foreach ($listaEditorial2 as $resultadoEditorial2) { ?>                                              
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input type="text" name="lib_ubicacion" class="material-control tooltips-general" pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]+{2,48}" placeholder="Escribe aquí la ubicación del libro" required>
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <span>Origén</span>
                                    <select name="lib_idcargo"class="tooltips-general material-control">
                                        <option value="0">Selecciona un origén</option>                                    
                                        <?php foreach ($listaCargo2 as $resultadoCargo2) { ?>                                              
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <span>Estado</span>
                                    <select name="lib_idestado"class="tooltips-general material-control">
                                        <option value="0" disabled="" selected="">Selecciona el estado del libro</option>                                                                                                     
                                        <?php foreach ($listaEstado2 as $resultadoEstado2) { ?>                                              
