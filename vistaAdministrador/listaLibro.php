    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema biblioteca <small>Listados Libros</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation"class="active"><a href="<?= REGISTRAR_LIBRO ['url'] ?>">Libros</a></li>      
                <li role="presentation"><a href="<?= REGISTRAR_EJEMPLAR ['url'] ?>">Ejemplares</a></li>
        </div>
<br>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?= REGISTRAR_LIBRO ['url'] ?>">Nuevo libro</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de libros</h2>            
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Categoria</th>
                    <th class="div-table-cell">ISBN</th>
                    <th class="div-table-cell">Titulo</th>
                    <th class="div-table-cell">Autor</th>                    
                    <th class="div-table-cell">Editorial</th>                    
                    <th class="div-table-cell">Ubicación</th>  
                    <th class="div-table-cell">Cargo</th>                                                        
                    <th class="div-table-cell">Actualizar</th> 
                    <th class="div-table-cell">Ver Disponibilidad</th>  
                                </tr>
                            </thead>                          
                            <tbody>
                              <?php 
                          foreach ($listaLibro as $resultadoLibro) { ?> 
                               <tr>                                                                                                                 <td class="div-table-cell"><img  src="<?= PROYECTO_RECURSOS_AR.$resultadoLibro->ruta?>" width="100px" height="100px"></td> 
                            <td class="div-table-cell"><?= $resultadoLibro->nombredewey ?></td>
                            <td class="div-table-cell"><?= $resultadoLibro->codigoisbn ?></td>
                            <td class="div-table-cell"><?= $resultadoLibro->titulolibro ?></td>
                            <td class="div-table-cell"><?= $resultadoLibro->nombresautor ?></td>    
                            <td class="div-table-cell"><?= $resultadoLibro->nombreeditorial ?></td>  
                             <td class="div-table-cell"><?= $resultadoLibro->ubicacion ?></td>      
                             <td class="div-table-cell"><?= $resultadoLibro->nombrecargo ?></td>     
                                    <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_LIBRO['url'].'?idlibro='.$resultadoLibro->idlibro?>" class="btn btn-success"> 
                                                      <i class="zmdi zmdi-refresh"></i>
                                          </a></td> 
                                           <td class="div-table-cell"><a href="<?=CONSULTAR_EJEMPLAR_ADMINISTRADOR['url'].'?idlibro='.$resultadoLibro->idlibro?>" class="btn btn-info"> 
