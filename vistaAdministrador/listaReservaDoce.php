            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Cancelar</th>  
                            ...
                            <tbody>
                              <?php                               
                          foreach ($listaReservasDoce as $resultadoReservaDoce) { ?> 
                                <tr>
                            <td class="div-table-cell"><?= $resultadoReservaDoce->numerodocumento ?></td>
                            <td class="div-table-cell"><?= $resultadoReservaDoce->codigounico ?></td>                            
                            <td class="div-table-cell"><?= $resultadoReservaDoce->fechainicio ?></td>                           
                            <td class="div-table-cell"><?= $resultadoReservaDoce->fechafin ?></td>                             
                            <td class="div-table-cell"><?= $resultadoReservaDoce->nombreestado ?></td>                  
                            <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_RESERVA_DOCENTE['url'].'?idreserva='.$resultadoReservaDoce->idreserva?>" class="btn btn-success"> 
                                                      <i class="zmdi zmdi-refresh"></i>
                                          </a></td> 
                                          <td class="div-table-cell"><a href="<?=CANCELAR_RESERVA_DOCENTE['url'].'?idreserva='.$resultadoReservaDoce->idreserva?>" class="btn btn-info"> 
