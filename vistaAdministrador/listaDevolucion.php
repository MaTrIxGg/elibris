...
<html lang="es">
    <head>
        <title>Lista Devoluciones Pendiantes</title>
        <meta charset="UTF-8">
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>Proceso de devolución</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                    <li role="presentation"><a href="<?= CONSULTAR_RESERVA['url'] ?>">Reservas</a></li>
                    <li role="presentation"><a href="<?= CONSULTAR_PRESTAMO['url'] ?>">Préstamo</a></li>
                    <li role="presentation" class="active"><a href="<?= CONSULTAR_DEVOLUCION['url'] ?>">Devolución</a></li>
                    
            </div>
            <div class="container-fluid">
                <h2 class="text-center all-tittles">Devoluciones Pendientes</h2>              
                                ...
                                <div class="card">                                    
                                    <div class="body table-responsive">
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                <?php foreach ($listaDevoluciones as $resultadoDev) { ?> 
                                                  <tr>      
                                                      <td class="div-table-cell"><?= $resultadoDev->numerodocumento ?></td>                                    <td class="div-table-cell"><?= $resultadoDev->codigounico ?></td>                                       <td class="div-table-cell"><?= $resultadoDev->fechaprestamo ?></td>                                     <td class="div-table-cell"><?= $resultadoDev->fechalimite ?></td>                                    
