            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Ver Disponibilidad</th>  
                            ...
                            <tbody>
                              <?php 
                          foreach ($listaLibroEstudiante as $resultadoLibroEstudiante) { ?> 
                               <tr>                                                                                                                    <td class="div-table-cell"><img  src="<?= PROYECTO_RECURSOS_AR.$resultadoLibroEstudiante->ruta?>" width="80px" height="80px"></td>                   
                            <td class="div-table-cell"><?= $resultadoLibroEstudiante->nombredewey ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroEstudiante->codigoisbn ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroEstudiante->titulolibro ?></td>
                            <td class="div-table-cell"><?= $resultadoLibroEstudiante->nombresautor ?></td> 
                            <td class="div-table-cell"><?= $resultadoLibroEstudiante->nombreeditorial ?></td>
                             <td class="div-table-cell"><?= $resultadoLibroEstudiante->ubicacion ?></td>      
                         <td class="div-table-cell"><a href="<?=CONSULTAR_EJEMPLAR_ESTUDIANTE['url'].'?idlibro='.$resultadoLibroEstudiante->idlibro?>" class="btn btn-info"> 
