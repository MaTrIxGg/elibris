    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <li  class="tooltips-general btn-help" data-placement="bottom" title="Ayuda" id="btnGuardar">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>Devolucion</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">              
                <li role="presentation" ><a href="<?= CONSULTAR_RESERVA['url'] ?>">Reservas</a></li>
                <li role="presentation"><a href="<?= REGISTRAR_DEVOLUCION['url'] ?>">Devolucion</a></li> 
                <li role="presentation" class="active"><a href="<?= CONSULTAR_DEVOLUCION['url'] ?>">Devolución</a></li>
                </ul>
            </div>
            <br>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            <li class="active">Nueva Devolucion</li>
                            <li><a href="<?= CONSULTAR_DEVOLUCIONES['url'] ?>">Listado de Devoluciones</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="container-fluid">           
                <div class="title-flat-form title-flat-blue">Ingresar una Devolución</div>
                <form method="POST" action="<?= REGISTRAR_DEVOLUCION['url'] ?>" autocomplete="off"> 
                    <div class="row">                        
                        <input type="hidden" name="dev_idprestamo" class="material-control"  value="<?= $prestamoReg->idprestamo ?>" >  
                              <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                             <div class="group-material">    
                                <span>Número Documento</span>
                                <select name="dev_idusuario"class="tooltips-general material-control" value="<?= $prestamoReg->idusuario ?>">
                                     <option value="<?= $prestamoReg->idusuario ?>"><?= $prestamoReg->numerodocumento ?></option>
                                 </select>
                            </div> 
                       </div> 
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                             <div class="group-material">   
                                ...
                                <select name="dev_idejemplar"class="tooltips-general material-control" value="<?= $prestamoReg->idejemplar ?>">
                                     <option value="<?= $prestamoReg->idejemplar ?>"><?= $prestamoReg->codigounico ?></option>
                                 </select>
                            </div> 
                       </div> 
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">    
                             <div class="group-material">   
                                <input type="date" name="" class="material-control" placeholder="Nombres del autor" required pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]+{2,48}" maxlength="" minlength="" value="<?= $prestamoReg->fechaprestamo ?>">
...
?>
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="hidden" name="dev_fechadevolucion" class="material-control" placeholder="Nombres del autor" required pattern="[a-zA-ZáéíóúñÁÉÍÓÚÑ-]+{2,48}" value="<?php echo $fecha;?>">    
                               <span class="highlight"></span>      
                                <span class="bar"></span> 
