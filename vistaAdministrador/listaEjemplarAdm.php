    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>Listado ejemplares por Libro</small></h1>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Lista de ejemplares</li>
                        </ol>
                    </div>
                </div>                  
            </div>
            <div class="container-fluid">
                <h2 class="text-center all-tittles">lista de ejemplares por Libro</h2>    
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    <tr>
                            ...
                            <tbody>
                               <?php foreach ($listaEjemplarAdm as $resultadoEjemplarAdm) { ?>    
                               <tr>    
                                    <td class="div-table-cell"><?= $resultadoEjemplarAdm->codigounico ?></td>
                                    <td class="div-table-cell"><?= $resultadoEjemplarAdm->titulolibro ?></td>
                                    <td class="div-table-cell"><?= $resultadoEjemplarAdm->fechaingreso ?></td>          
                                    <td class="div-table-cell"><?= $resultadoEjemplarAdm->descripcion ?></td>
                                    <td class="div-table-cell"><?= $resultadoEjemplarAdm->nombreestado ?></td>
                                    <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_EJEMPLAR['url'].'?idejemplar='.$resultadoEjemplarAdm->idejemplar?>" class="btn btn-success"> 
