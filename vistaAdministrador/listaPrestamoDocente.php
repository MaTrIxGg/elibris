  ...
  <div class="navbar-lateral full-reset">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema biblioteca <small>Mis Préstamo</small></h1>
            </div>
        </div>              
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    ...
                    <th class="div-table-cell">Fecha Límite</th>                                
                            ...
                            <tbody>
                              <?php                               
                          foreach ($listaprestamoDoc as $resultadoPreDoc) { ?> 
                              <tr>                                                                             
                            <td class="div-table-cell"><?= $resultadoPreDoc->codigounico ?></td>          
                            <td class="div-table-cell"><?= $resultadoPreDoc->fechaprestamo ?></td>         
                            <td class="div-table-cell"><?= $resultadoPreDoc->fechalimite ?></td>           
                                </tr> 
                                <?php }
                 ?>              
                            </tbody> 
