...
<body>
   <div class="navbar-lateral full-reset">
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container-fluid">           
                <div class="title-flat-form title-flat-blue">Reaalizar una nueva reserva</div>
                <form method="POST" action="<?= GUARDAR_RESERVA['url'] ?>" autocomplete="off"> 
                    <div class="row">                      
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                            <div class="group-material"> 
                                ...
                                <select name="res_idejemplar"class="tooltips-general material-control">
                                    <option value="0">Selecciona el ejemplar disponible</option>                                    
                                    <?php foreach ($listaEjemplaRe as $resultadoEjemplarRe) { ?>                                              
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                            <div class="group-material">                              
                                ...
                                <select name="res_idestado"class="tooltips-general material-control">  
                                    <?php foreach ($listaEstadoRes as $resultadoEstadoRes) { ?>   
                                      <option value="<?= $resultadoEstadoRes->idestado ?>"><?= $resultadoEstadoRes->nombreestado ?></option> 
                                    <?php }
                                    ?>
                                </select>                                  
                            </div> 
