    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">              
               <li role="presentation" ><a href="<?= REGISTRAR_AUTOR['url'] ?>">Autor</a></li>
               <li role="presentation" class="active"><a href="<?= REGISTRAR_EDITORIAL['url'] ?>">Editorial</a></li>
            </ul>
        </div>
<!--        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="<?= PROYECTO_RECURSOS_ASSETS_IMG ?>category.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nueva editorial de libros,se deben de llenar todos los campos del siguiente formulario para poder registrar la editorial exitosamente.
                </div>
            </div>
        </div>-->
<br>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      ...
                      <li><a href="<?= CONSULTAR_EDITORIAL['url'] ?>">Listado de editoriales</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">           
              ...
              <form method="POST" action="<?=GUARDAR_EDITORIAL['url'] ?>" autocomplete="off">                                                                                                                               
                    <div class="row">
                          <div class="col-xs-offset-2 col-md-8 col-sm-offset-3">
                            <img src="<?= PROYECTO_RECURSOS_ASSETS_ICONS ?>informacion.png" class="material-control tooltips-general" style="width:2.5%;" data-toggle="tooltip" data-placement="top" title="Escriba el nombre de la editorial">
                        </div>
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">                            
                            <div class="group-material">
                                <input type="text" name="edi_nombreeditorial" class="material-control" placeholder="Nombre de la editorial" required="" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}">                              
