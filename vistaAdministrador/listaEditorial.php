    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation"><a href="<?= REGISTRAR_AUTOR ['url'] ?>">Autores</a></li>
                <li role="presentation" class="active"><a href="<?= REGISTRAR_EDITORIAL ['url'] ?>">Editoriales</a></li>
            </ul>
        </div>        
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a href="<?= REGISTRAR_EDITORIAL['url'] ?>">Nueva editorial</a></li>
                      <li class="active">Listado editoriales</li>
                    </ol>
                </div>
            </div>    
        </div>
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de editoriales</h2>
        ...
        <div class="row clearfix">
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>                                                                       
                                    <td class="div-table-cell"><?= $resultado->nombreeditorial ?></td>            
                                    <td class="div-table-cell"><a href="<?=MOSTRAR_MODIFICAR_EDITORIAL['url'].'?ideditorial='.$resultado->ideditorial?>" class="btn btn-success"> 
