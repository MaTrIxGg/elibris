                ...
                <div class="full-reset nav-lateral-list-menu">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?= CONSULTAR_AUTOR_ESTUDIANTE['url'] ?>"><i class="zmdi zmdi-account zmdi-hc-fw"></i>&nbsp;&nbsp;Lista de Autores</a></li>
                                <li><a href="<?= CONSULTAR_EDITORIAL_ESTUDIANTE['url'] ?>"><i class="zmdi zmdi-collection-text zmdi-hc-fw"></i>&nbsp;&nbsp;Lista de Editoriales </a></li>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema biblioteca <small>autor </small></h1>
                </div>
            </div>                      
            <div class="container-fluid">
                <h2 class="text-center all-tittles">lista de autores</h2>
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                    <tr>
                                    ...
                                    <th class="div-table-cell">Apellidos</th>                                    
                                </tr>
                            </thead>
                          
                            <tbody>
                                <?php foreach ($listaAutorEstudiante as $resultadoEstudiante) { ?>    
                                <tr>                                                                        
                                    <td class="div-table-cell"><?= $resultadoEstudiante->nombresautor ?></td>
                                    <td class="div-table-cell"><?= $resultadoEstudiante->apellidosautor ?></td>         
                                </tr> 
                                <?php }
                 ?>              
                            </tbody>           
